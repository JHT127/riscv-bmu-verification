...
interface bmu_interface (input logic clk);
        ...
        // rtl control adapter ----------------------------------------
                always_comb begin
                        ...
                        dut_ap.siext_h = ap.siext_h;
                        dut_ap.min = ap.min;
                        dut_ap.max = ap.max;
                        dut_ap.pack = ap.pack;
                        dut_ap.packu = ap.packu;
                        dut_ap.packh = ap.packh;
                        dut_ap.rol = ap.rol;
                        dut_ap.ror = ap.ror;
                        dut_ap.grev = ap.grev;
                        dut_ap.gorc = ap.gorc;
                        ...
                        dut_ap.binv = ap.binv;
                        dut_ap.bext = ap.bext;
                        dut_ap.sh1add = ap.sh1add;
                        dut_ap.sh2add = ap.sh2add;
                        dut_ap.sh3add = ap.sh3add;
                        dut_ap.zba = ap.zba;
                        dut_ap.land = ap.land;
                        dut_ap.lor = ap.lor;
                        dut_ap.lxor = ap.lxor;
                        ...
                        dut_ap.jal = ap.jal;
                        dut_ap.predict_t = ap.predict_t;
                        dut_ap.predict_nt = ap.predict_nt;
