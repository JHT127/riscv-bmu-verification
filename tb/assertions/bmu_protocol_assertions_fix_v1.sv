// fixed-RTL protocol assertions ===========================================

module bmu_protocol_assertions_fix_v1
        import rtl_pkg::*;
        #(
...
bind Bit_Manipulation_Unit_fix_v1 bmu_protocol_assertions_fix_v1 protocol_assertions_i (
        .clk       (clk),
        .rst_l     (rst_l),
        .valid_in  (valid_in),
